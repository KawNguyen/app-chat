...
export function DirectMessageProfile({ user }: DirectMessageProfileProps) {
    ...
    <div className="w-full shrink-0 bg-background">
      <ScrollArea className="h-full">
        <div className="flex flex-col">
          ...
          {/* Danger Zone */}
          <div className="px-4 py-3">
            <button className="w-full flex items-center gap-3 text-sm text-destructive hover:bg-destructive/10 rounded p-2 transition-colors">
